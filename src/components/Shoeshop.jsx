...
import ProductChitiet from './ProductChitiet'
            ...
            <div className='container'>
                <div className="row">
                    ...
                    <div className="col-9">
                        ...
                        <ProductLish Shoeslist={this.Shoeslist} btnchitiet={this.btnchitiet} />
                        <ProductChitiet chiTietShoe={chiTietShoe}/>
                    </div>
                </div>
